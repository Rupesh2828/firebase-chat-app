...
const LeftNav = () => {
  ...
  //this is for handling profile image of user.
  ...
  const handleUpdateProfile = (type, value) => {
    //there are 4 ways/types of updating users profile like- color,name,photo and remove photo
    let obj = { ...currentUser };
    switch (type) {
      case "color":
        obj.color = value; //overwriting exsting color from obj with the value we have given
  ...
  const onkeyup = (event) => {
    //checking if the name is edited or not
